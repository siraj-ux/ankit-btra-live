...
export default function OtoPage() {
  ...
  useEffect(() => {
    setFormData((prev) => ({
      ...
      // Reset sensitive fields if user unchecks the upgrade
              ...
              <div className="space-y-1.5">
                ...
                <div className="flex gap-6 px-1">
                  {["male", "female"].map((g) => (
                    <label
                      key={g}
                      className="flex items-center gap-2 cursor-pointer text-sm font-medium text-gray-600 hover:text-black transition-colors"
                    >
                      <input
                        type="radio"
                        name="gender"
