          ...
          <div className="relative text-white px-6 py-10 md:px-12 md:py-14 border border-white/10 rounded-3xl">
            ...
            <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto mb-10">
              {actions.map((action, index) => (
                <div
                  key={index}
                  className="group text-center rounded-2xl p-6 bg-white/10 border border-white/15 hover:border-yellow-400/40 transition-all duration-300 backdrop-blur-sm"
                >
